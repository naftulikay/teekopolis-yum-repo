...
%description
libdvdnav provides a simple library for reading DVD video discs. The code is
...
%check
checksec --file %{buildroot}%{_libdir}/libdvdnav.so.4.2.0
...
* Wed Oct 13 2004 Ville SkyttÃ¤ <ville.skytta at iki.fi> - 0:0.1.10-0.lvn.1
- Update to 0.1.10.
